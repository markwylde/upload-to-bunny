...
export const deleteFile = async (targetDirectory, options) => {
  const url = `https://${options.region ? options.region + "." : ""}storage.bunnycdn.com/${options.storageZoneName}/${targetDirectory}`;
...
export const uploadFile = async (sourcePath, targetPath, options) => {
  const url = `https://${options.region ? options.region + "." : ""}storage.bunnycdn.com/${options.storageZoneName}/${targetPath}`;
