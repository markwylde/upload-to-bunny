...
const deleteFile = async (targetDirectory, options) => {
...
const uploadFile = async (sourcePath, targetPath, options) => {
...
const processPath = async (sourcePath, targetPath, options) => {
...
const uploadDirectory = async (sourceDirectory, targetDirectory, options = {}) => {
  options = {
